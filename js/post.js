 ...
 function renderPost(postId, postData, username, userLiked, likeCount) {
     ...
     postElement.innerHTML = `
         ...
         <img src="${postData.mediaUrl}" alt="${postData.title}" class="post-image">
 ...
 async function fetchPosts() {
     const postsQuery = query(collectionGroup(db, "dropping"));
     onSnapshot(postsQuery, async (querySnapshot) => {
         ...
         querySnapshot.forEach(async (postDoc) => {
             ...
             // Fetch user's profile data to get the username
             ...
             // Render the post with the username, like status, and like count
             renderPost(postId, postData, username, userLiked, likeCount);
         });
     });
 }
